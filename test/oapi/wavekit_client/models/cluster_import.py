...
T = TypeVar("T", bound="ClusterImport")
...
class ClusterImport:
    ...
    Attributes:
        ...
        host (str): Cluster host address
        sql_port (int): SQL connection port
        meta_port (int): Metadata node port
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cluster_import.additional_properties = d
        return cluster_import
